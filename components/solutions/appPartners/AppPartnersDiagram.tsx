...
const ENGINE_CARDS: EngineSubCard[] = [
  {
...
const CAPTIONS: { arrow: string; label: string; body: string }[] = [
  {
    arrow: "→",
    label: "You send",
      ...
      >
        <div className="max-w-[62ch]">
          <p className="reveal-row eyebrow [transition-delay:80ms]">
            How it fits inside your product
          </p>
          <h2
            id="ap-diagram-label"
          ...
          >
            One integration. Every coaching moment.
          </h2>
        </div>
        ...
        <div className="mt-14 grid grid-cols-1 gap-10 lg:mt-16 lg:grid-cols-[minmax(0,1.35fr)_minmax(0,1fr)] lg:gap-14">
          ...
          >
            <div className="grid grid-cols-1 items-stretch gap-6 md:grid-cols-[minmax(0,0.9fr)_auto_minmax(0,1.1fr)] md:gap-6">
              ...
              <EnginePanel cards={ENGINE_CARDS} />
            </div>
          </div>
          ...
          {CAPTIONS.map((c, i) => {
            ...
            return (
              ...
              >
                ...
                <p className="body-quiet max-w-[34ch]">{c.body}</p>
              </li>
            );
          })}
        </ol>
...
function EnginePanel({ cards }: { cards: EngineSubCard[] }) {
  return (
