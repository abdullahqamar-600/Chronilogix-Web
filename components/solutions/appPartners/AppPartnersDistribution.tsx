...
const DEALS: { label: string; caption: string }[] = [
      ...
      >
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] lg:items-center lg:gap-16">
          <div>
            ...
            >
              Every plan you close makes your product better.
            </h2>
            <div className="mt-6 max-w-[54ch] space-y-5 body-prose">
              <p className="reveal-row [transition-delay:280ms]">
                When you sell a new health plan into your platform,
                Chronilogix comes with it. Automatically. Your coaching
                depth grows every time BD wins &mdash; no roadmap cost, no
                re-integration.
              </p>
              <p className="reveal-row [transition-delay:420ms]">
                It&rsquo;s the rare distribution model where each new
                partnership expands the underlying product, instead of
                stretching your team thinner.
              </p>
            </div>
          </div>
