...
const HEADLINE_LINES: { text: string; tone: "bright" | "muted" }[] = [
  { text: "The engagement layer", tone: "bright" },
  { text: "your platform is missing.", tone: "muted" },
];
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-16">
          <div>
            ...
            >
              ...
              Motivational Interviewing research, delivered as an API your
              team can integrate this quarter.
            </p>
