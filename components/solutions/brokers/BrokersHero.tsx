...
const HEADLINE_LINES: { text: string; tone: "bright" | "muted" }[] = [
  { text: "A Reality Every Broker", tone: "bright" },
  { text: "Should Know", tone: "muted" },
];
    ...
    >
      ...
      <div className="container-page relative pt-32 pb-24 md:pt-40 md:pb-28 lg:pt-48 lg:pb-32">
        <div className="w-full text-center">
          ...
          >
            Move beyond traditional plan design. Chronilogix helps brokers
            address chronic conditions, behavioral health, and delayed care
            with AI-powered coaching that changes member behavior before
            expensive claims happen.
          </p>
