...
const HEADLINE_LINES: HeadlineLine[] = [
  {
    text: "The cost leak isn’t plan design.",
    variant: "lead",
  },
  {
    text: "It’s member behavior.",
    variant: "hero",
    accentWords: 2,
  },
];
    ...
    >
      ...
      <div className="container-page relative pt-32 pb-24 md:pt-40 md:pb-28 lg:pt-48 lg:pb-32">
        <div className="w-full text-center">
          ...
          >
            The real drivers are chronic conditions, behavioral health, and
            delayed care. Chronilogix reaches them with AI coaching that
            changes member behavior before expensive claims happen.
          </p>
