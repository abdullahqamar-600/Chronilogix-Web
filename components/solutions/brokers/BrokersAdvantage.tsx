    ...
    >
      ...
      >
        ...
        <div className="reveal-row mx-auto max-w-3xl text-center [transition-delay:80ms]">
          ...
          >
            For your clients, fewer claims.{" "}
            <span className="text-brand-700">
              For you, an advantage you can defend.
            </span>
          </h2>
          <p className="mx-auto mt-5 max-w-[54ch] body-quiet">
            The same coaching that lowers your clients&rsquo; spend changes
            how you show up: sharper positioning, an earlier seat at the cost
            conversation, and a number you can stand behind.
          </p>
        </div>
