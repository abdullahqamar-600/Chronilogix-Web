      ...
      >
        <div className="grid grid-cols-1 items-stretch gap-12 md:gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:gap-20">
          ...
          <div className="flex flex-col justify-center order-1 lg:order-2">
            ...
            >
              Two specialized AI coaches: one for mental health, one for
              diabetes.
            </h2>
            <p className="reveal-row mt-6 max-w-[52ch] body-prose [transition-delay:280ms]">
              Millie coaches members through mental and behavioral health,
              while Roni guides those managing diabetes and chronic
              conditions. Both run Motivational Interviewing, grounded in 30
              years of behavioral science research, personalized to each
              member and available without waiting on a clinician&rsquo;s
              calendar.
            </p>
            <p className="reveal-row mt-5 max-w-[46ch] font-serif text-row font-normal leading-[1.15] text-ink [transition-delay:380ms]">
              Not reminders. Not wellness noise.{" "}
              <span className="text-brand-700 italic">
                Real behavior change, at scale.
              </span>
            </p>
