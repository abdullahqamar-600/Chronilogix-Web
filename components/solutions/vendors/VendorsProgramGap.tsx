      ...
      >
        <div className="grid grid-cols-1 items-stretch gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:gap-16">
          ...
          <div className="order-1 lg:order-2">
            ...
            >
              Specialized 24/7 AI coaches that keep patients{" "}
              <span className="text-brand-700 italic">engaged.</span>
            </h2>

            <p className="reveal-row mt-5 max-w-[46ch] body-prose [transition-delay:240ms]">
              Chronilogix gives every patient a dedicated AI coach for their
              condition, a mental health coach or a diabetes coach, available
              24/7 to guide, motivate, and support them throughout their care.
            </p>
            <p className="reveal-row mt-4 max-w-[46ch] body-prose [transition-delay:320ms]">
              Each coach is trained in Motivational Interviewing and backed by
              Dr. Ken Resnicow&rsquo;s 30+ years of evidence-based behavioral
              change research, helping patients overcome the everyday barriers
              that derail treatment and engaging them continuously, not
              episodically:
            </p>
