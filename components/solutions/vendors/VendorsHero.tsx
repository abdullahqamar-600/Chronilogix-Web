...
const HEADLINE_LINES: HeadlineLine[] = [
  {
    text: "Success isn’t what you deliver.",
    variant: "lead",
  },
  {
    text: "It’s what patients keep using.",
    variant: "hero",
    accentWords: 99,
  },
];
        ...
        <div className="w-full text-center">
          ...
          >
            <p className="body-prose">
              Chronilogix helps chronic care vendors improve adherence,
              increase retention, and deliver measurable health outcomes
              through 24/7 AI-powered coaching that works alongside your
              existing products.
            </p>
          </div>
