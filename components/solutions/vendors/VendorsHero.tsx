...
const HEADLINE_LINES: { text: string; tone: "bright" | "muted" }[] = [
  { text: "Your product works.", tone: "bright" },
  { text: "The challenge is after delivery.", tone: "muted" },
];
    ...
    >
      ...
      <div className="container-page relative pt-28 pb-20 md:pt-32 md:pb-24 lg:pt-36 lg:pb-28">
        <div className="w-full text-center">
          ...
          <div
            className="mx-auto mt-7 max-w-[72ch] md:mt-8"
            style={{
              opacity: subTailReveal,
          ...
          >
            <p className="body-prose">
              If you&rsquo;re selling chronic care products, success
              isn&rsquo;t measured by what gets delivered &mdash; it&rsquo;s
              measured by what patients continue to use. Chronilogix helps
              chronic care vendors improve adherence, increase retention, and
              deliver measurable health outcomes through 24/7 AI-powered
              coaching that works alongside your existing products.
            </p>
          </div>
