      ...
      >
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-stretch lg:gap-14 xl:gap-20">
          ...
          <div className="flex flex-col lg:h-full">
            ...
            >
              The real barriers to adherence aren&rsquo;t medical.{" "}
              <span className="text-brand-700 italic">They&rsquo;re human.</span>
            </h2>
            <p className="reveal-row mt-4 max-w-md body-prose [transition-delay:220ms]">
              Chronilogix addresses the emotional, behavioral, and
              socio-economic barriers that cause drop-off, without relying on
              expensive, hard-to-scale clinical teams.
            </p>
