...
const TRACK_TITLE = "The vendor brief";
const TRACK_SUBTITLE = "Listen · 2:19";
...
export function VendorsAudioPlayerBar({
  ...
  const { isPlaying, currentTime, duration, toggle, seekTo, registerAnchor } =
    useVendorsAudio();
 ...
 * Keeps playing across scroll; dismissible via its close button.
 */
export function VendorsStickyAudio() {
  const { isPlaying, currentTime, duration, toggle, seekTo, activated, dismiss } =
    useVendorsAudio();
