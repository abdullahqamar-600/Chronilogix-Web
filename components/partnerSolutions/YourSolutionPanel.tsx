  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="italic text-brand-700">Your Solution</span> +
          Chronilogix
        </h2>
        ...
        <h3 className="reveal-row mx-auto mt-4 font-serif font-normal text-[21px] leading-[1.3] text-ink [transition-delay:140ms] sm:text-[24px] md:whitespace-nowrap lg:text-[28px]">
          Imagine what AI coaching could do for{" "}
          <span className="italic text-brand-700">your organization.</span>
        </h3>

        <p className="reveal-row mx-auto mt-8 max-w-[54ch] text-[16px] leading-[1.6] text-ink/80 [transition-delay:220ms] md:text-[18px]">
          Whether you provide wellness programs, digital health platforms,
          pharmacies, medical devices, health screenings, employer benefits,
          disease management, remote monitoring, nutrition, or telehealth —{" "}
          <span className="text-brand-700">
            there&rsquo;s a coaching layer to add.
          </span>
        </p>
          ...
          <div className="relative overflow-hidden rounded-[20px] bg-ink px-7 py-12 text-left sm:rounded-[24px] sm:px-10 md:rounded-[28px] md:px-14 md:py-16 lg:py-20">
            ...
            <div className="relative max-w-3xl">
              ...
              <p className="mt-5 max-w-[62ch] text-[15px] leading-relaxed text-paper/70 md:mt-6 md:text-lg">
                Chronilogix can add a clinically grounded, Motivational
                Interviewing-based AI coaching layer that increases engagement,
                improves outcomes, and creates new value for your members.
              </p>
