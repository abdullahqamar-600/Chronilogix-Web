    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="italic text-brand-700">Increase Your Value.</span>
        </h1>

        <p className="reveal-row mx-auto mt-7 max-w-[62ch] body-prose [transition-delay:220ms] md:mt-8">
          Chronilogix doesn&rsquo;t replace your product &mdash; we make it
          smarter, more engaging, and more effective through continuous AI
          coaching.
        </p>

        <p className="reveal-row mx-auto mt-3 max-w-[52ch] body-quiet [transition-delay:280ms]">
          Three examples of how we bundle with industry leaders.
        </p>
