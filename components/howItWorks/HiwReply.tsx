...
const MEMBER_MESSAGE = "I skipped lunch again. I know I shouldn't.";
const COACH_REPLY =
    ...
    >
      <div className="container-page">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            Each reply weighs{" "}
            <span className="text-ink-muted">everything Chronilogix knows.</span>
          </h2>
        </div>
        ...
        >
          <DissectionColumn playState={playState} />
          <MemberViewColumn playState={playState} />
        </div>
      </div>
    </section>
  );
...
function DissectionColumn({
  ...
  return (
    <div className="flex flex-col">
      <p className="eyebrow-muted text-center">Inside one reply</p>
      ...
      >
        ...
        >
          <p className="text-[13px] font-medium text-ink-soft">Thinking</p>
...
function MariaAvatar({ className }: { className?: string }) {
  return (
    <span
      aria-hidden
...
function MemberViewColumn({
  ...
  return (
    <div className="flex flex-col">
      <p className="eyebrow-muted text-center">The app members open between sessions</p>
      ...
      >
        ...
        <img
          ...
          alt="Chronilogix on a member's phone showing daily greeting, upcoming Roni session, goals in flight"
...
const REASONING_ROWS: ReasonRow[] = [
  {
    label: "Remembers",
    value: "Last session, stress eating after work calls",
    Icon: ClockBackIcon,
  },
  {
    label: "Pattern this week",
    value: "Third lunch skipped in five days",
    Icon: TrendIcon,
  },
  {
    label: "Goal in motion",
    value: "Eat lunch before the 1pm call",
    Icon: TargetIcon,
  },
  {
    label: "Emotional read",
    value: "Self critical, bracing for a lecture",
    Icon: PulseIcon,
  },
  {
    label: "MI technique",
    value: "Reflect what she noticed, then ask",
    Icon: ReflectIcon,
  },
  {
    label: "Holds back",
    value: "Direct advice, a checklist, a fix",
    Icon: BlockIcon,
  },
];
