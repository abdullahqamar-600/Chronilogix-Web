    ...
    >
      <div className="container-page pt-24 md:pt-32 lg:pt-40">
        ...
        <div className="max-w-4xl">
          ...
          >
            One engine.{" "}
            <span className="text-ink-muted">Two clinical voices.</span>
          </h2>
          <p
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 md:mt-10 md:grid-cols-2 md:gap-8">
          <PersonaColumn persona={RONI} delay={480} inView={inView} />
          <PersonaColumn persona={MILLIE} delay={560} inView={inView} />
        </div>
